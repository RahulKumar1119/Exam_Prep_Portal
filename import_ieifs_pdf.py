#!/usr/bin/env python3
"""
Parse JAIIB-IEIFS-By Dr. Murugan.pdf and upload all MCQs to jaiib-question-bank DynamoDB.
...
def parse(lines: list) -> list:
    ...
    while i < n:
        ...
        q_text = re.sub(
            r'^(Indian Economy\s*&\s*Indian Financial System|'
...
if __name__ == '__main__':
    path = 'JAIIB-IEIFS-By Dr. Murugan.pdf'
