#!/usr/bin/env python3
"""
Parse AFM.pdf (Edutap format) and upload all MCQs to jaiib-question-bank DynamoDB.
Options: a) b) c) d)  Answer line: Solution: A
"""
...
ANS_PAT = re.compile(r'^(?:Answer|Solution)\s*:\s*([a-dA-D])', re.I)
HEADER  = re.compile(
