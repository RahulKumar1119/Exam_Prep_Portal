  ...
  <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-12 px-4">
    <div className="max-w-3xl mx-auto bg-white dark:bg-gray-900 rounded-xl shadow p-8 border border-gray-200 dark:border-gray-700">
      ...
      <Section title="8. Cookies">
        <p>We use a small set of cookies and similar storage, controlled by your consent choices (change them anytime via the "Cookie Settings" link in the footer):</p>
